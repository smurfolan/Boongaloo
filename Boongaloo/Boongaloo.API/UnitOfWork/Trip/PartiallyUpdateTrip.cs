...
namespace Boongaloo.API.UnitOfWork.Trip
{
        ...
        JsonPatchDocument<DTO.Trip>>, IDisposable
    {
        ...
        public UnitOfWorkResult<DTO.Trip> Execute(JsonPatchDocument<DTO.Trip> input)
        {
            ...
            var dtoForPatch = Mapper.Map<Boongaloo.Repository.Entities.Trip,
             DTO.Trip>(tripEntity);
            ...
            // update entity
            tripEntity = Mapper.Map<DTO.Trip, Boongaloo.Repository.Entities.Trip>
                (dtoForPatch);
